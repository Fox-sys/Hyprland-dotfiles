...
PACMAN_DEPENDENCIES = [
    ...
    "pavucontrol", "nwg-look", "mpv", "feh", "xdg-desktop-portal-wlr", "man", "obs-studio", "alacritty", "thunar", "zsh",
    ...
    "xcb-util-wm", "xorg-xwayland", "libinput", "libliftoff", "libdisplay-info", "cpio", "tomlplusplus", "hyprlang", "hyprcursor", 
    "hyprwayland-scanner", "xcb-util-errors", "curl", "wget", "micro", "hyprland", "telegram-desktop", "fastfetch"
]
